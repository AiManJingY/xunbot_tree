...
DEVICE_PATH := device/xunbot/xunbot
...
TARGET_KERNEL_CONFIG := xunbot_defconfig
TARGET_KERNEL_SOURCE := kernel/xunbot/xunbot
...
# Recovery
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery/root/fstab.rk30board.bootmode.emmc
